...
// (async () => {
//   const a = await validateUser("Minn");
//   const b = await validateUser("Flower");

//   console.log(a);

//   const cbName = makeName("Minn", "Flower");

//   const chatBox = await validateChatBox(cbName, [a, b]);

//   console.log("chatBox:", chatBox);

//   const pop1 = await chatBox.populate("users").execPopulate();
//   console.log("chatBox:", chatBox);

//   const pop2 = await chatBox
//     .populate({ path: "messages", populate: "sender" })
//     .execPopulate();
//   console.log("chatBox:", chatBox);
// })();
  ...
  client.on("message", async function incoming(message) {
    ...
    switch (type) {
      ...
      case "CHAT": {
        ...
        // chatBoxes["a_b"].add(client);
        // console.log("chatBoxes:", chatBoxes); // ws client
